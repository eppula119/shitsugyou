...
<main class="l-main">
  <div class="p-questWrap">
    <img src="/images/panda.png" style="width: 80px"  alt="" class="p-questWrap__img p-neaterImg">
    ...
    <form action="" class="p-answerForm">
      <button class="p-answerForm__btn c-btn">働いてた</button>
      <button class="p-answerForm__btn c-btn">働いてない</button>
      <button class="p-answerForm__btn c-btn">多分働いてた</button>
      <button class="p-answerForm__btn c-btn">分からない</button>
    </form>
